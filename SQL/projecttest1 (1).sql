...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 28, 2020 lúc 12:43 PM
...
(14, 'mon1234', '202cb962ac59075b964b07152d234b70', 'Student', 'Thanh Nguyen', 'abc@gmail.com', NULL, NULL, NULL),
(15, 'mon12345', '202cb962ac59075b964b07152d234b70', 'Student', 'thanhduy', 'abc@gmail.com', NULL, NULL, NULL),
(16, 'mon26', '202cb962ac59075b964b07152d234b70', 'Student', 'thanhduy', 'abc@gmail.com', 'Ha Noi', 'd?dasd', '2020-11-11'),
(17, 'mon123456', '202cb962ac59075b964b07152d234b70', 'Student', 'thanhduy', 'abc@gmail.com', NULL, NULL, NULL),
(18, 'mon2tuoi', '202cb962ac59075b964b07152d234b70', 'Student', 'thanhduy', 'abc@gmail.com', NULL, NULL, NULL);
...
(17, 'Class Day 1', '<p>ddddddddddddddddd</p>\r\n', 1, '2020-09-08 08:41:45'),
(18, 'Class Day 2', '<p>dwd</p>\r\n', 1, '2020-09-08 11:40:21');
...
(2, 'hhhhh', 6, '2020-09-22 13:08:24', 17),
(3, 'jdjdsk\r\n', 6, '2020-09-22 13:09:43', 18),
(4, 'hhh', 6, '2020-09-22 13:17:44', 17),
(5, 'hello', 6, '2020-09-29 11:22:23', 17),
(6, 'đasa', 14, '2020-11-25 17:39:16', 17);
...
INSERT INTO `student` (`Student_id`, `User_id`, `Budget`, `payment_status`, `Time`) VALUES
(13, 14, 3000, 'D', '2020-12-21 17:00:00'),
(14, 15, NULL, NULL, NULL),
(15, 16, 900, 'D', '2020-12-21 17:00:00'),
(16, 17, 100, '', NULL),
(17, 18, 0, 'D', '2020-12-22 17:00:00');
...
--
-- Đang đổ dữ liệu cho bảng `upload_file`
--

INSERT INTO `upload_file` (`upload_id`, `fileName`, `fileUrl`, `type`, `Class_id`) VALUES
(39, 'bvb3wzn9ordr8mwvnhrsyd-970-80.jpg', 'uploads/bvb3wzn9ordr8mwvnhrsyd-970-80.jpg', 'image', 17),
(40, 'Capture.PNG', 'uploads/Capture.PNG', 'image', 17),
(41, 'Coursework-group.pdf', 'uploads/Coursework-group.pdf', 'file', 17);
...
--
-- Đang đổ dữ liệu cho bảng `video_upload`
--

INSERT INTO `video_upload` (`video_id`, `VideoName`, `videoUrl`, `Class_id`) VALUES
(4, '2019_11_30_20_33_IMG_2626.mp4', 'videos/2019_11_30_20_33_IMG_2626.mp4', 17);
...
--
ALTER TABLE `payment`
  ADD CONSTRAINT `pay_ibfk_1` FOREIGN KEY (`St_id`) REFERENCES `student` (`Student_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `student`
--
ALTER TABLE `student`
  ADD CONSTRAINT `student_ibfk_1` FOREIGN KEY (`User_id`) REFERENCES `account` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
