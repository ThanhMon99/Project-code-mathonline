    ...
    <main class="login-body" data-vide-bg="assets/img/login-bg.mp4">
        ...
        <form class="form-default" id="demoForm" action="#" method="post" >
            ...
            <div class="login-form">
                ...
                <p>Have an account? <a href="login.php" class="registration">Log In</a></p>
            </div>
        </form>
        <!-- /end register form -->
    </main>
...
if ($pdoResult) {
    ...
    $stmt2 = $conn->prepare("INSERT INTO student (User_id, Budget, payment_status) VALUE ('{$iduser}','','')");
    $pdoResult2 = $stmt2->execute();
     $URL = "http://localhost/ProjectTest/login.php";
