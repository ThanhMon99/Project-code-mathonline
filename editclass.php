...
<html lang="en"> 
    ...
    <body>  
        ...
        <div class="container">
            ...
            <br />
            <form method="post" action="editclass.php" enctype="multipart/form-data">
...
<?php
    if (isset($_POST['submit'])) {
        ...
        $stmt1 = $conn->prepare("Update class set title = '$title', content = '$content' where Class_id = '$class'");
        $pdoResult = $stmt1->execute();
        if ($pdoResult) {
            echo "Class has been created";
            
            $URL = "http://localhost/ProjectTest/displayClass.php?id="."$class";
